package tema789.ejemplos.conYSinEventos;
...
/** Demo de interacción de ratón SIN gestión de eventos de Swing
 * Controlando directamente la pulsación de ratón desde el hilo principal
 * @author andoni.eguiluz @ ingenieria.deusto.es
 */
public class DibujarSinEventos {

	/** Método principal de ejecución del ejercicio
	 * @param args	No utilizado
	 */
	public static void main(String[] args) {
		DibujarSinEventos mgt = new DibujarSinEventos();
		mgt.run();
	}
